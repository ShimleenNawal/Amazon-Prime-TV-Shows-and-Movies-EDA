...
This project performs exploratory data analysis(EDA) on Amazon Prime Video's content library to unravel insights into content diversity, trends, and viewer preferences using Python and Data Visualization. 
